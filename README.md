...
<html lang="en">
  <head>
    ...
    <title>Chill</title>
    <link href="https://d33wubrfki0l68.cloudfront.net/bundles/8be48126aaf76de2a89a565e5cc8cb32e60d2b9e.css" rel="stylesheet" />
  ...
  <body>
    <div class="tm-container">
      <div class="tm-text-white tm-page-header-container">
        ...
        <h1 class="tm-page-header">الفاتحة</h1>
      </div>
  ...
  <source src="http://www.truemuslims.net/Quran/Kurdish/001.mp3" type="audio/mpeg" />
      ...
      <footer>
        <p class="tm-text-white tm-footer-text">
          Copyright &copy; 2020
          <a href="#" class="tm-footer-link">ibra</a>
        </p>
      </footer>
    </div>
